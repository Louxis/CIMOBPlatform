...
namespace CIMOBProject.Controllers
{
    public class StudentSearchController : Controller
    {
        ...
        // GET: StudentSearch/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: StudentSearch/Create
